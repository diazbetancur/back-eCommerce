...
{
    /// <summary>
    /// Servicio para emitir y validar tokens de confirmaci�n con duraci�n corta (15 min)
    /// </summary>
    ...
    public class ConfirmTokenService : IConfirmTokenService
    {
        ...
        public string GenerateConfirmToken(Guid provisioningId, string slug)
        {
            ...
            var token = new JwtSecurityToken(
                ...
                audience: _audience,
                claims: claims,
                expires: DateTime.UtcNow.AddMinutes(15), // Token v�lido por 15 minutos
        ...
        public ClaimsPrincipal? ValidateConfirmToken(string token)
        {
            try
            {
                ...
                // Verificar que sea un token de confirmaci�n
