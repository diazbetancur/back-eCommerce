...
namespace CC.Aplication.Provisioning
{
    ...
    public class InitProvisioningRequest
    {
        ...
        [RegularExpression("^[a-z0-9-]+$", ErrorMessage = "El slug solo puede contener letras min�sculas, n�meros y guiones")]
    ...
    /// <summary>
    /// Response de inicializaci�n de aprovisionamiento
    /// </summary>
    ...
    /// <summary>
    /// Response de confirmaci�n de aprovisionamiento
    /// </summary>
