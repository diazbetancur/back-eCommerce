...
namespace CC.Infraestructure.TenantDbMigrations
{
    ...
    [Migration("20260324164413_AddPopupManagementModule")]
    partial class AddPopupManagementModule
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CC.Domain.Entities.LoyaltyRedemption", b =>
                {
                    ...
                    b.HasIndex("CouponCode")
                        .HasDatabaseName("IX_LoyaltyRedemptions_CouponCode");

                    b.HasIndex("LoyaltyAccountId")
                        .HasDatabaseName("IX_LoyaltyRedemptions_AccountId");

                    b.HasIndex("RedeemedAt")
                        .HasDatabaseName("IX_LoyaltyRedemptions_RedeemedAt");

                    b.HasIndex("RewardId")
                        .HasDatabaseName("IX_LoyaltyRedemptions_RewardId");

                    b.HasIndex("Status")
                        .HasDatabaseName("IX_LoyaltyRedemptions_Status");
            ...
            modelBuilder.Entity("CC.Domain.Entities.LoyaltyReward", b =>
                {
                    ...
                    b.HasIndex("AvailableUntil")
                        .HasDatabaseName("IX_LoyaltyRewards_AvailableUntil");

                    b.HasIndex("DisplayOrder")
                        .HasDatabaseName("IX_LoyaltyRewards_DisplayOrder");

                    b.HasIndex("IsActive")
                        .HasDatabaseName("IX_LoyaltyRewards_IsActive");
            ...
            modelBuilder.Entity("CC.Domain.Entities.LoyaltyTransaction", b =>
                {
                    ...
                    b.Property<string>("AdjustmentTicketNumber")
                        .HasMaxLength(100)
                    ...
                    b.HasIndex("AdjustedByUserId")
                        .HasDatabaseName("IX_LoyaltyTransactions_AdjustedByUserId");

                    b.HasIndex("AdjustmentTicketNumber")
                        .HasDatabaseName("IX_LoyaltyTransactions_AdjustmentTicketNumber");
            ...
            modelBuilder.Entity("CC.Infraestructure.Tenant.Entities.Popup", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CC.Infraestructure.Tenant.Entities.TenantAsset", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("PhysicalDeletionAttempts")
                        .HasColumnType("integer");

                    b.Property<bool>("PhysicalDeletionExecuted")
                        .HasColumnType("boolean");

                    b.Property<DateTime?>("PhysicalDeletionExecutedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("PhysicalDeletionLastError")
                        .HasColumnType("text");

                    b.Property<bool>("PhysicalDeletionRequired")
                        .HasColumnType("boolean");
                    ...
                    b.ToTable("TenantAssets", "public");
                });

            modelBuilder.Entity("CC.Infraestructure.Tenant.Entities.TenantAssetQuotaSnapshot", b =>
                {
                    b.Property<Guid>("TenantId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("AllowVisualModules")
                        .HasColumnType("boolean");

                    b.Property<int>("CurrentImageCount")
                        .HasColumnType("integer");

                    b.Property<long>("CurrentTotalBytes")
                        .HasColumnType("bigint");

                    b.Property<int>("CurrentVideoCount")
                        .HasColumnType("integer");

                    b.Property<DateTime>("LastPlanSyncAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.ToTable("TenantAssetQuotaSnapshots", "public");
                });
